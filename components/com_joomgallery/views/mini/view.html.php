...
// $Id: view.html.php 3348 2011-09-27 17:06:40Z chraneco $
/****************************************************************************************\
**   JoomGallery  1.5.7                                                                 **
...
class JoomGalleryViewMini extends JoomGalleryView
{
  ...
  function display($tpl = null)
  {
    ...
    $url   = JRoute::_('index.php?view=mini&format=raw', false);
    ...
    if($extended > 0)
    {
      ...
      $arr[]                  = JHTML::_('select.option', '3', JText::_('JGS_MINI_READMORE'));
      ...
      if($params->get('upload_enabled'))
      {
        ...
        if($params->get('upload_catids') && count($catids))
        {
          ...
          foreach($uploadcategories as $category)
          {
            ...
            {
              $categories[] = JHTML::_('select.option', $category->cid, JHTML::_('joomgallery.categorypath', $category->cid, ' &raquo; ', false, false, true));
            }
          }
        ...
        else
        {
          ...
          {
            $lists['upload_categories'] = JHTML::_('joomselect.categorylist', 0, 'catid');
          }
          else
          {
            // Get the parents of category
            $lists['upload_categories'] = JHTML::_('joomselect.usercategorylist', 0);
          }
        }
        ...
        if($params->get('upload_enabled'))
        {
          ...
          $this->_ambit->script('JGS_COMMON_PLEASE_SELECT_IMAGE');
      ...
      if($params->get('create_category'))
      {
        ...
        if($params->get('parent_catids') && count($catids))
        {
          ...
          {
            $lists['parent_categories'] = JHTML::_('select.genericlist', $categories, 'parent');
          }
        }
        else
        {
          ...
          {
            // Get the parents of category
            $lists['parent_categories'] = JHTML::_('joomselect.usercategorylist', 0, null, 'editcat');
          }
        }
    ...
    $this->_ambit->script('JGS_MINI_PLEASE_ENTER_TEXT');
